...
public class GamePanel extends JPanel implements ActionListener{
	...
	static final int GAME_UNITS = (SCREEN_WIDTH*SCREEN_HEIGHT)/UNIT_SIZE; //how many objects to fit on the screen
	static final int DELAY = 75;
	final int x[] = new int[GAME_UNITS]; //BODY PART OF THE SNAKE SIZE
	...
	public void move() {
		//for shifting snake body parts around 
